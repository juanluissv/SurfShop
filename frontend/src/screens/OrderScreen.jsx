      ...
      <Loader />
        ...
        <div class=""><br/><br/><br/><br/><br/><br/><br/>
          <div className="breadcrumb-area bg-gray">
            ...
            <div className='billing-info-wrap orderTittle'>
            <h3 className='orderTittle'>Order {order._id}</h3>
            </div>
          ...
          <Row>
              ...
              <ListGroup variant='flush'>                        
                  <ListGroup.Item className='billing-info-wrap'>
                  <h3>Shipping</h3>
                  <p>
...
//     ) : (
//     <div><br /><br /><br />
//         <h4 className='orderTittle'>Order {order._id}</h4><br />
//         <Row>
//             <Col md={8}>
//             <ListGroup variant='flush'>
//                 <ListGroup.Item>
